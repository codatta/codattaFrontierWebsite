  ...
  const options = [
    {
      ...
      title: <div className="mb-4 text-sm font-semibold">Select one from the following five options.</div>,
      options: [
    ...
    },
    {
      ...
      title: <div className="mb-4 text-sm font-semibold">The material contains either 1 or 2 arms?</div>,
      options: [
        { value: '1', label: '1 arm' },
    ...
    },
    {
      ...
      title: <div className="mb-4 text-sm font-semibold">Is this arm mobile or static?</div>,
      options: [
  ...
  return (
    <div className="rounded-2xl bg-[#252532] p-6">
      ...
      <p className="mb-4 mt-2 text-gray-400">
        Identify the main subject of the action in as detailed modules as possible.
      </p>
      <div className="flex flex-col gap-4">
        {options.map((item, index) => (
          <RadioCard
            ...
            title={<div className="mb-4 text-sm font-semibold">{item.title}</div>}
            name={item.name}

...
export const IdentityIcon = () => (
  <IconBox>
    <svg width={96} height={96} viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="48" cy="48" r="22" fill="url(#paint0_radial_45142_42523)" />
      <path
...
export const ActivityIcon = () => (
  <IconBox>
    <svg width={96} height={96} viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="48" cy="48" r="22" fill="#F7F7F7" />
      <circle cx="48" cy="48" r="22" fill="url(#paint0_radial_45487_10879)" />
      <path
...
export const StakingIcon = () => (
  <IconBox>
    <svg width={96} height={96} viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="48" cy="48" r="22" fill="#F7F7F7" />
      <circle cx="48" cy="48" r="22" fill="url(#paint0_radial_45487_10911)" />
      <path
...
export const ContributionIcon = () => (
  <IconBox>
    <svg width={96} height={96} viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="48" cy="48" r="22" fill="#F7F7F7" />
      <circle cx="48" cy="48" r="22" fill="url(#paint0_radial_45487_10943)" />
      <path
        d="M51 46H43.9515L43.8378 45.4318L43.6877 44.6811L42.9268 44.5284C39.4678 43.8344 38.6517 40.5752 38.5606 39.849L38.4878 39.268H37.8978L36.8978 39.2681L36.8978 48.2435C37.054 48.0673 37.3364 47.7818 37.7661 47.5029L38.2713 47.1749L38.6253 47.6713C39.2458 48.5422 41.5658 51.5204 42.0628 52H45.0068C44.7578 51.7135 44.4239 51.3283 44.0206 50.8497L43.4357 50.1558L44.2987 49.851C47.4646 48.7323 50.1547 46.5293 51 46.1264V46ZM51 51V58H45L45 56H48.1672C48.0163 55.4526 47.7686 54.8967 47.4042 54.3411L46.9602 53.664L47.761 53.4475C48.4068 53.2729 49.2081 53.0183 50.0487 52.6105L51 52.1489V51Z"
        fill="black"
        stroke="black"
        strokeWidth="1.5"
      />

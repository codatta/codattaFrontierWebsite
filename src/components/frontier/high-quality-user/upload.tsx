        ...
        {value.length === 0 ? (
          isMobile ? (
            <div className={cn('flex items-center gap-4 rounded-xl bg-[#252532] p-3', className)} onClick={handleClick}>
              <div
                className={cn(
                  'relative flex size-[100px] shrink-0 items-center justify-center overflow-hidden rounded-lg bg-[#FFFFFF1A]',
            ...
            <div className="flex h-[130px] items-stretch gap-2">
              ...
              >
                ...
                <p className="text-sm text-[#606067]">{description || 'Click to upload screenshot'}</p>
              </div>
            </div>
          )
        ) : (
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <div className="flex w-full items-center justify-between">
                ...
                >
                  <X className="size-4 text-gray-400 group-hover:text-red-400" />
                </button>
              </div>
            </div>
          </div>

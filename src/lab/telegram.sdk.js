    ...
    function initWidget(widgetEl) {
      ...
      if (
        ...
        !(
          ...
          (widgetEl.tagName.toUpperCase() == 'BLOCKQUOTE' && widgetEl.classList.contains('telegram-post'))
        )
      ) {
        return null
      }
      ...
      if ((widgetId = widgetEl.getAttribute('data-telegram-post'))) {
        ...
        widgetElId = 'telegram-post-' + widgetId.replace(/[^a-z0-9_]/gi, '-') + (comment ? '-comment' + comment : '')
        ...
        widgetsOrigin = getWidgetsOrigin('https://t.me', 'https://post.tg.dev')
        widgetElId =
          'telegram-discussion-' + widgetId.replace(/[^a-z0-9_]/gi, '-') + '-' + ++window.Telegram.__WidgetUuid
        ...
        src =
          ...
          widgetId +
          '?origin=' +
          encodeURIComponent(location.origin || location.protocol + '//' + location.hostname) +
          '&return_to=' +
    ...
    var TelegramLogin = {
      ...
      _auth: function (options, callback) {
        ...
        var popup_url =
          ...
          '&origin=' +
          encodeURIComponent(location.origin || location.protocol + '//' + location.hostname) +
          (options.request_access ? '&request_access=' + encodeURIComponent(options.request_access) : '') +

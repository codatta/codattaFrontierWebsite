...
//               sub_cate_description:
//                 'On the Telegram mobile app, participate in the codatta Telegram Mini-Program
// to earn unique daily points rewards and easily validate anytime, anywhere.\n',
//               award_icon:
...
//               sub_cate_description:
//                 'XnY is a blockchain network aimed at transforming the data economy by addressing inefficiencies in AI data markets and promoting a
// decentralized ecosystem that ensures fair compensation for data creators.',
//               award_icon:
...
//             description:
//               'Submit fashion data to maximize your rewards. This task offers unlimited submission opportunities.
// Unlocking endless opportunities to earn!(Rewards will be calculated within several minutes)',
//             type: 'MANUAL',
//             schema:

...
export const VALIDATION_TIPS = {
  decision:
    'Please choose your solid decision carefully. Too many wrong decisions may impact your reputation.',
  opinion:
    "If you haven't made a solid decision yet, feel free to express your opinion.",
  reason:
  ...
  detail:
    'Hovering over the entry title will display a description of the entry.'
}

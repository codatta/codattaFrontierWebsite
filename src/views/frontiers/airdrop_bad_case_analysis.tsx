...
import Guideline from '@/components/frontier/airdrop/bad-case/guideline'
import MyForm from '@/components/frontier/airdrop/bad-case/form'
        ...
        <div className="min-h-screen py-3 md:py-8">
          <div className="border-[#FFFFFF1F] pb-3 md:border-b md:pb-8">
            <h1 className="mx-auto flex max-w-[1320px] items-center justify-between px-6 text-center text-base font-bold">
              ...
              Objective Query on Model Badcase
              <span></span>
            </h1>
          </div>
...
// http://localhost:5175/frontier/project/AIRDROP_BAD_CASE_ANALYSIS/8608444186800101772

...
import Guideline from '@/components/frontier/airdrop/expert-answer/guideline'
import MyForm from '@/components/frontier/airdrop/expert-answer/form'
        ...
        <div className="min-h-screen py-3 md:py-8">
          <div className="border-[#FFFFFF1F] pb-3 md:border-b md:pb-8">
            <h1 className="mx-auto flex max-w-[1320px] items-center justify-between px-6 text-center text-base font-bold">
              ...
              Objective AI Model Boundary Case
              <span></span>
            </h1>
          </div>
...
// http://localhost:5175/frontier/project/AIRDROP_EXPERT_ANSWER_PROVISION/8608445859500101773

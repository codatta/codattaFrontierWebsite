...
export default function LLMFailureCases() {
  ...
  const usageItems = [
    ...
    {
      icon: <Languages className="size-full text-black" />,
      title: 'Multilingual Hallucination Analysis'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <img
        src="https://static.codatta.io/dataset/llm-failure-cases.png"
      ...
      <div className="mx-auto max-w-4xl px-5 py-6">
        ...
        <div className="mb-9">
          <h1 className="mb-4 text-2xl font-bold text-black">LLM-Failure-Cases (LLM)</h1>
          <p className="text-[15px] text-[#999999]">
            Codatta LLM Failure Cases is a specialized dataset focused on challenging prompts that cause
            state-of-the-art Large Language Models (LLMs) to produce incorrect, hallucinatory, or logically flawed
            responses. This community-driven collection contains over 800 failure cases spanning primarily English and
            Chinese, sourced from adversarial testing initiatives.
          </p>
        </div>
        ...
        <div className="mb-9 grid grid-cols-2 gap-4 sm:grid-cols-3">
          <div className="rounded-[20px] bg-white/60 px-4 py-3 shadow-glass">
            ...
            <p className="text-[13px] text-[#999]">
              <strong className="text-[20px] font-semibold text-black">164 </strong>MB
            </p>
          </div>
          <div className="rounded-[20px] bg-white/60 px-4 py-3 shadow-glass">
            <p className="text-[13px] text-[#999]">Parquet Size</p>
            <p className="text-[13px] text-[#999]">
              <strong className="text-[20px] font-semibold text-black">163 </strong>MB
            </p>
          </div>
          <div className="rounded-[20px] bg-white/60 px-4 py-3 shadow-glass">
            <p className="text-[13px] text-[#999]">Total Rows</p>
            <p className="text-[13px] text-[#999]">
              <strong className="text-[20px] font-semibold text-black">1,000</strong>
            </p>
          </div>
        </div>

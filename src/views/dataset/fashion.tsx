...
export default function Fashion() {
  ...
  const usageItems = [
    ...
    {
      icon: <Palette className="size-full text-black" />,
    ...
    {
      icon: <Tag className="size-full text-black" />,
      title: 'E-commerce Tagging'
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <img src="https://static.codatta.io/dataset/fashion.png" className="block aspect-[362/240] w-full" alt="" />

      {/* Content Area */}
      <div className="mx-auto max-w-4xl px-5 py-6">
        {/* Title and Description */}
        <div className="mb-9">
          <h1 className="mb-4 text-2xl font-bold text-black">Fashion</h1>

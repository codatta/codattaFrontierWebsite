...
// TODO TransitionEffect need merge
...
export default function Component() {
  ...
  if (!activityGroups?.length)
    return (
      <Spin className="flex min-h-screen w-full items-center justify-center py-10" />
    )
  ...
  return (
    <Link to={'/quest/' + activity.sub_cate_id}>
      ...
      >
        ...
        <div className="mb-8 mt-6 line-clamp-2 h-[60px] text-xl font-bold leading-[30px]">
          {activity.sub_cate_name}
        </div>
          ...
          <Col className="max-w-[50%]">
            <Flex vertical gap={6} align="center" wrap>
              <div>
                ...
                <div
                  className={cn(
                    'whitespace-nowrap pb-1 text-xs',
